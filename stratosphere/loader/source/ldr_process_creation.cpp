...
namespace ams::ldr {
    ...
    namespace {
        ...
        Result ValidateProgramVersion(ncm::ProgramId program_id, u32 version) {
            ...
            if (hos_version >= hos::Version_12_1_0) {
                entries = g_MinimumProgramVersions1210;
                num_entries = g_MinimumProgramVersionsCount1210;
            } else if (hos_version >= hos::Version_11_0_0) {
